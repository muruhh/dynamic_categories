      ...
      $.ajax({
        ...
        success: function success(data) {
          if (data.length == 0) {
            ...
            var content = "<div class='pt-2 content text-center cat" + get_attr + "'>" + subtitle + "<select class='m-2 categories sub-category' data-content='" + random + "'><option value='na' disabled selected>Select sub category</option>" + options + "</select></div>";
